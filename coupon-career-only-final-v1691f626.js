...
(() => {
'use strict';
if (window.__AT_COUPON_CAREER_ONLY_FINAL_V1691F626__) return;
window.__AT_COUPON_CAREER_ONLY_FINAL_V1691F626__ = true;

const VERSION = 'COUPON-CAREER-ONLY-FINAL-V16.9.1F60.26';
const SOURCE = 'CAREER_ROADMAP_RANKING_RAW_EVIDENCE_F6023';
const TICKET_VERSION = 'CAREER-COUPON-V16.9.1F60.26-CAREER-ONLY';
let busy = false;
...
window.ATCouponCareerOnlyFinalV626 = {
  version:VERSION,
  source:SOURCE,
  open,
  build,
