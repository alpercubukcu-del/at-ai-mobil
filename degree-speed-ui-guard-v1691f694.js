...
const VERSION='DEGREE-SPEED-UI-GUARD-V16.9.1F60.94';
...
function cardHtml(result){
  const ctx=result?.degreeSpeed?.trackContext||{},w=ctx?.weather||{};
...
window.ATDegreeSpeedUiGuardF6094={version:VERSION,ensure:ensureCard};
console.info('[AT AI]',VERSION,'aktif — derece kartı analiz yeniden çizimlerinde korunur.');
})();