...
// build-runtime-v148, auto-resume-v128.js yerine compact bir IIFE'yi final bundle'a ekliyor.
...
app=app.slice(0,start)+"\n/* V16.9.4 boot auto-resume removed: user action required */\n"+app.slice(end+endMarker.length);
app+=`\n;window.__AT_AUTO_RESUME_DISABLED_V1694__='USER-ACTION-ONLY-V16.9.4';\n`;
...
console.log('[AT AI] V16.9.4 build tamamlandı: V12.8 compact boot auto-resume final bundle’dan fiziksel olarak kaldırıldı; uygulama açılışında analiz otomatik başlamaz.');
