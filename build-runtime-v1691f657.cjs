...
for(const token of[
  ...
  'CAREER-DAILY-ARCHIVE-PER-RACE-V16.9.1F60.58',
...
console.log('[AT AI] V16.9.1F60.58 build complete: calculated and memory-restored Career races are saved and verified as separate Daily Archive records.');
