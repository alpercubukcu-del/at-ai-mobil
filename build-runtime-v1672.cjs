...
if(!app.includes('COUPON-DECISION-FULLSCREEN-V16.7.2')||!app.includes('document.documentElement.appendChild(el)')) throw new Error('[V16.7.2] tam ekran düzeltmesi production bundle içine girmedi.');
new Function(app);
...
console.log('[AT AI] V16.7.2 build tamamlandı: Kupon Veri Denetimi Android mobilde documentElement üstünde gerçek tam ekran açılır.');
