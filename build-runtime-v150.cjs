...
for (const file of [APP, STYLE, INDEX, ARCHIVE_JS, ARCHIVE_FIX_JS, ARCHIVE_CSS]) {
...
html = html
  .replace('/at-ai-styles-v141.css?v=1410', '/at-ai-styles-v141.css?v=1461')
  .replace('/at-ai-app-v142.js?v=1420', '/at-ai-app-v142.js?v=1461');
fs.writeFileSync(INDEX, html, 'utf8');

console.log('[AT AI] V15.0 build tamamlandı: günlük kariyer arşivi + kalıcı 5 Model cache + PDF export + güvenli yeniden hesaplama eklendi.');
