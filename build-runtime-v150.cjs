...
for (const file of [APP, STYLE, INDEX, ARCHIVE_JS, ARCHIVE_FIX_JS, PDF_V147_JS, ARCHIVE_CSS]) {
...
html = html
  .replace(/\/at-ai-styles-v141\.css\?v=\d+/, '/at-ai-styles-v141.css?v=1470')
  .replace(/\/at-ai-app-v142\.js\?v=\d+/, '/at-ai-app-v142.js?v=1470');
fs.writeFileSync(INDEX, html, 'utf8');

console.log('[AT AI] V15.0 build tamamlandı: günlük kariyer arşivi + kalıcı 5 Model cache + sade V14.7 PDF + güvenli yeniden hesaplama eklendi.');
