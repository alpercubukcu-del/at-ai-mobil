...
for(const file of EXTRAS)new Function(fs.readFileSync(file,'utf8'));
...
let html=fs.readFileSync(INDEX,'utf8').replace(/\/at-ai-app-v142\.js\?v=\d+/,'/at-ai-app-v142.js?v=169265');
fs.writeFileSync(INDEX,html,'utf8');
if(!html.includes('/at-ai-app-v142.js?v=169265'))throw new Error('[F60.63] Cache bust failed.');
console.log('[AT AI] V16.9.1F60.63 build complete: Güncel Analiz first-open calendar/multifilter + archive DB v3 option loading + compact dropdowns + selected-reference career filtering.');
