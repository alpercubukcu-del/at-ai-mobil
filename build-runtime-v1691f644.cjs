...
if(!html.includes('/at-ai-app-v142.js?v=169249'))throw new Error('[F60.46] Cache bust failed.');
console.log('[AT AI] V16.9.1F60.46 build complete: pair cards show condition fit, not capped model boost; missing HP is not displayed as 0.');
