...
for(const f of [BASE,VERCEL,ROUTING_PATCH,MENU_PATCH,COMPACT_PATCH,BET_DROPDOWN_PATCH,WINNER_SHARED_PATCH,MODEL_ROADMAP_CACHE_PATCH]) if(!fs.existsSync(f)) throw new Error(`[V16.8.8] Eksik dosya: ${path.basename(f)}`);
...
if(!app.includes('DRAWER-MENU-NUMBERING-V16.8.2')) app += `\n;window.__AT_DRAWER_NUMBERING_RETIRED_V1682__='DRAWER-MENU-NUMBERING-V16.8.2';\n`;
