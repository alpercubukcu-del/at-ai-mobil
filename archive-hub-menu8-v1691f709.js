...
function dates(){const a=document.getElementById('rrDateFromF6093'),b=document.getElementById('rrDateToF6093');if(!a||!b)return null;const x=(a.value||'').slice(0,10),y=(b.value||'').slice(0,10);if(!x||!y)return null;return x<=y?[x,y]:null}
